...
function TonyBaiduMap(options) {
    ...
    var defaults = {
        ...
        infotitle: '<b style=\"color:#cc5522; font-size:14px\">�����˲�</b/>',

        infocontent: '<p style="font-size:12px;line-height:180%;">��ַ���츮����ж�1388������㳡A��7¥746<br/><a href="http://j.map.baidu.com/6pxDx" target="_blank">�鿴������ַ</a></p>'
    ...
    _marker.setTitle(defaults.titles); //����title

    if (defaults.isanimation) {

        _marker.setAnimation(BMAP_ANIMATION_BOUNCE); //�����Ķ���

    };



    var infoWindow = new BMap.InfoWindow(defaults.infocontent, { width: defaults.infowidth, height: defaults.infoheight, title: defaults.infotitle });  // ������Ϣ���ڶ���



    map.disableDragging();     //��ֹ��ק
